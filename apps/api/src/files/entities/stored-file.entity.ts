...
@Index(
  'uq_stored_files_bucket_object_key',
  ['bucket', 'objectKey'],
  { unique: true },
)
@Index('idx_stored_files_company_id', ['companyId'])
@Index(
  'idx_stored_files_company_direction',
  ['companyId', 'direction'],
)
@Index(
  'idx_stored_files_company_category',
  ['companyId', 'category'],
)
@Index(
  'idx_stored_files_company_status',
  ['companyId', 'status'],
)
