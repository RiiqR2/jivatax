  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...auditColumns,
          { name: "sii_account_id", type: "char", length: "36" },
          { name: "accounting_family", type: "varchar", length: "100" },
          { name: "statement_section", type: "varchar", length: "30" },
          { name: "balance_nature", type: "varchar", length: "10" },
          {
            name: "tax_type",
            type: "varchar",
            length: "40",
          ...
          { name: "is_control_account", type: "tinyint", width: 1, default: 0 },
          { name: "is_contra_account", type: "tinyint", width: 1, default: 0 },
          { name: "is_current", type: "tinyint", width: 1, isNullable: true },
          { name: "is_residual", type: "tinyint", width: 1, default: 0 },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...auditColumns,
          { name: "rule_key", type: "varchar", length: "100" },
          { name: "name", type: "varchar", length: "255" },
          { name: "priority", type: "int" },
          { name: "condition", type: "json" },
          { name: "action", type: "json" },
          { name: "explanation", type: "varchar", length: "500" },
          { name: "active", type: "tinyint", width: 1, default: 1 },
        ],
      }),
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: "internal_name", type: "varchar", length: "500" },
          { name: "normalized_name", type: "varchar", length: "500" },
          { name: "sii_account_id", type: "char", length: "36" },
          {
          ...
          { name: "last_confirmed_at", type: "datetime", precision: 6 },
          { name: "last_confirmed_by_user_id", type: "char", length: "36" },
          { name: "promotion_eligible", type: "tinyint", width: 1, default: 0 },
          { name: "active", type: "tinyint", width: 1, default: 1 },
        ],
      }),
    );
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...auditColumns,
          { name: "company_id", type: "char", length: "36" },
          { name: "tax_period_id", type: "char", length: "36" },
          { name: "company_account_id", type: "char", length: "36" },
          { name: "account_name", type: "varchar", length: "500" },
          { name: "normalized_name", type: "varchar", length: "500" },
          { name: "observed_section", type: "varchar", length: "30" },
          { name: "decision", type: "varchar", length: "30" },
          { name: "decision_reason", type: "varchar", length: "100" },
          { name: "algorithm_version", type: "varchar", length: "50" },
          { name: "candidates", type: "json" },
        { name: "discarded_candidates", type: "json" },
        { name: "rules_evaluated", type: "json" },
        { name: "generated_at", type: "datetime", precision: 6 },
        ],
      }),
    );
    await queryRunner.createIndex(
