...
export function UploadDialog({
  ...
  function validate(): boolean {
    ...
    if (next.file?.includes("tamaño máximo"))
      next.file = `El archivo supera el máximo de ${formatFileSize(String(maxSizeBytes))}.`;
    setErrors(next);
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      await uploadCompanyFile(api, companyId, file, category, {
        ...
        onStage: (nextStage) => {
          uploadPhase.failedAtStorage = nextStage === "uploading";
          setStage(nextStage);
        },
      });
      onUploaded();
      ...
      setErrors({
        submit: uploadPhase.failedAtStorage
          ? "No se pudo subir el archivo al almacenamiento. Inténtalo nuevamente."
          : "No se pudo completar la carga. Inténtalo nuevamente.",
      });
      setStage("idle");
    } finally {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="upload-title">Subir archivo</h2>
        <p className="modal-intro">
          Agrega un archivo contable a esta empresa.
        </p>
        {errors.submit && (
          ...
          <form onSubmit={submit} noValidate>
            <div className="field">
              ...
              <input
                ...
                onChange={(event) => {
                  ...
                  setErrors((old) => ({ ...old, file: undefined }));
                }}
              />
              <p className="hint">
                Tamaño máximo: {formatFileSize(String(maxSizeBytes))}
              </p>
            ...
            <div className="field">
              ...
              <select
                ...
                onChange={(event) => {
                  ...
                  setErrors((old) => ({ ...old, category: undefined }));
                }}
              >
            ...
            <div className="actions">
              ...
              <button className="button" type="submit" disabled={busy}>
                {busy ? stages[stage] : "Subir archivo"}
              </button>
            </div>
          </form>
        )}
