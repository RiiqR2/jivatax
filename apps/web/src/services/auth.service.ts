...
export const authService = {
  ...
  async selectOrganization(organizationId: string): Promise<Session> {
    return (
      await api.post<Session>("/auth/select-organization", { organizationId })
    ).data;
  },
};
