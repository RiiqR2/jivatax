...
export interface SessionResponse { user: AuthUser; organization: AuthOrganization | null; organizations: AuthOrganization[]; requiresOrganizationSelection: boolean }
